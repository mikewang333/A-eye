...
class Medium():
    ...
    def fit(self, batches, val_batches, nb_epoch=1, epoch_num):
        """
        ...
        weights = []
        for i in range(5):
            weights[i] = weight_calculation(epoch_num, INITIAL_WEIGHTS[i], FINAL_WEIGHTS[i])
    ...
    def weight_calculation(t, w_0, w_f):
